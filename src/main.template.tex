...
\begin{paracol}{2}
\cvsection{$experience_section.title$}

[[ for event in experience_section.events ]]
\cvevent{$event.job_title$}{$event.company$}{$event.start_date$ -- $event.end_date$}{$event.location$}
\begin{itemize}
...
[[ if loop.index < experience_section.events|length ]]
\divider
[[ endif]]
