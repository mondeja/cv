...
\BLOCK{ if experience_section.jobs.events|length > 0 }
\cvsection{\VAR{experience_section.jobs.title}}

\BLOCK{ for job in experience_section.jobs.events }
...
\BLOCK{ if loop.index < experience_section.jobs.events|length }
\divider
\BLOCK{ endif }
\BLOCK{ endfor }
\BLOCK{ endif }
...
\BLOCK{ if experience_section.projects.events|length > 0 }
\cvsection{\VAR{experience_section.projects.title}}

\BLOCK{ for project in experience_section.projects.events }
...
\BLOCK{ if loop.index < experience_section.projects.events|length }
\divider
\BLOCK{ endif }
\BLOCK{ endfor }
\BLOCK{ endif }
