...
\cvsection{\VAR{publications.title}}

\nocite{*}

\BLOCK{ for entrytype in _bibdb }
\printbibliography[heading=pubtype,title={\printinfo{\\VAR{publications.entrytypes[entrytype].icon}}{\VAR{publications.entrytypes[entrytype].title}}},type=\VAR{ entrytype }]
\BLOCK{ if loop.index < _bibdb|length }
\divider
\BLOCK{ endif }
\BLOCK{ endfor }
